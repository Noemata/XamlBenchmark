...
namespace GraphicsTester.Scenarios
{
    public class TestPattern1 : AbstractScenario
    {
        ...
        public override void Draw(ICanvas canvas)
        {
            ...
            canvas.SetFillPaint(vPaint, new RectangleF(50, 700, 150, 750));
            canvas.FillRectangle(50, 700, 100, 50);

            canvas.SetFillPaint(vPaint, new RectangleF(200, 700, 300, 700));
            canvas.FillEllipse(200, 700, 100, 50);

            vPaint.AddOffset(.5f, Colors.IndianRed);
            canvas.SetFillPaint(vPaint, new RectangleF(350, 700, 450, 700));
            ...
            canvas.SetFillPaint(vPaint, new RectangleF(500, 700, 600, 700));
            canvas.FillPath(path);
            ...
            canvas.SetFillPaint(vPaint, new RectangleF(100, 825, 150, 850));
            canvas.FillRectangle(50, 800, 100, 50);

            canvas.SetFillPaint(vPaint, new RectangleF(250, 825, 300, 800));
            canvas.FillEllipse(200, 800, 100, 50);

            vPaint.AddOffset(.5f, Colors.IndianRed);
            canvas.SetFillPaint(vPaint, new RectangleF(400, 825, 450, 800));
            ...
            canvas.SetFillPaint(vPaint, new RectangleF(550, 825, 600, 800));
            canvas.FillPath(path);
