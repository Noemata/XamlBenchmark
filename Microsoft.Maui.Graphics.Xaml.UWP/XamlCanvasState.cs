...
using Microsoft.UI;
using Windows.UI.Text; // MP! qualify usage
    ...
    public class XamlCanvasState : CanvasState
    {
...
#else
                            brush.GradientStops.Add(new global::Microsoft.UI.Xaml.Media.GradientStop() { Color = stop.Color.AsColor(), Offset = stop.Offset });
#endif
...
#else
                return new SolidColorBrush(global::Microsoft.UI.Colors.White);
#endif
            }
        }
...
#endif
        {
            get
            {
                ...
                // MP! changed: was return new global::Windows.UI.Xaml.Media.FontFamily(style.FontFamily.Name)
#if WINDOWS_UWP
